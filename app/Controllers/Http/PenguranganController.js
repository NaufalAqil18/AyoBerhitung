...
class PenguranganController {
    async showLevel({ params, view, request, auth }) {
        ...
        return view.render('exercise/pengurangan_soal', { soal, skor, skorPersen, waktuMulai: waktuMulaiStr, waktuSelesai: waktuSelesaiStr, bintang1, bintang2, bintang3 })
    }
...
module.exports = PenguranganController 